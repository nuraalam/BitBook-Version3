...
function Post(data, hub) {
    ...
    self.numberOfLikes = ko.observable(self.Like);
    ...
    self.addLike = function () {
        ...
        self.hub.server.addLike({ "PostedBy": self.PostedBy, "PostId": self.PostId }).done(function (like) {
